...
核心是由多个独立羽片组成的佩戴式眼羽：连续遮住双眼，表面与配饰不出现眼睛意象，中央连接配饰根据服装设计。适用于明确成年的角色摄影、原创写真和造型探索。
...
```text
$yumao-photography 检查这张图的眼羽覆盖、眼睛意象、中央配饰与人体连接，
...
四种形态共同保留多羽片结构、适中外延和可辨认的中央配饰。构造定义见 [统一构造与四形态](references/form-family.md)；形态规则不等于四种都已有完整验证的成功样图。
